...
public class dailyReport {
    ...
    private Label selectfromdate = new Label("Select From: ");
    private Label selecttodate = new Label(" TO ");
    ...
    public VBox getdailyreport(){
        ...
        hboxtop.getChildren().addAll(selectfromdate,fromdate,selecttodate,todate,getreport);
        hboxtop.getStyleClass().addAll("background");
        hboxtop.setPadding(new Insets(10));
       
       vboxtop.getChildren().addAll(headingobj.hBox("DateWise Report :"),hboxtop);
    ...
    Amount = new TableColumn[6];
        ...
        getreport.setOnAction(e ->{
            fdate = (java.sql.Date.valueOf(fromdate.getValue())).toString();
            ndate =  java.sql.Date.valueOf(todate.getValue()).toString();
            String query = "RENEW_DATE BETWEEN '"+fdate+"' AND '"+ndate+"'";
